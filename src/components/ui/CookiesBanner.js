    ...
    return (
        <>
            <div className="pointer-events-none fixed inset-x-0 bottom-0 sm:bottom-1 sm:px-6 sm:pb-2 lg:px-8 max-w-7xl mx-auto z-50">
                <div className="pointer-events-auto flex flex-col sm:flex-row items-center justify-between gap-x-6 bg-gray-900 px-6 py-2.5 sm:rounded-xl sm:py-3 sm:pl-4 sm:pr-3.5">
