...
export default function CookieBanner() {
    ...
    if (!isBannerVisible) return null; // Ne rien afficher si la bannière est fermée

    return (
        <>
            <div className="pointer-events-none fixed inset-x-0 bottom-0 sm:bottom-1 sm:px-6 sm:pb-2 lg:px-8 max-w-7xl mx-auto">
