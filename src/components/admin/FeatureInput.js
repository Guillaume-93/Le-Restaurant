                ...
                <div className='flex items-start gap-x-2'>
                    ...
                    <div className='flex gap-x-2 mb-2'>
                        <button
                            ...
                            className="rounded-md text-sm font-semibold text-indigo-600 shadow-sm hover:bg-indigo-700"
                        >
                ...
                <div key={featureIndex} className="flex col-span-full gap-x-2">
                    ...
                    <div className='flex gap-x-2 items-center justify-start mb-4 sm:mb-2'>
                        <button
                            ...
                            className="rounded-md px-3 py-2 text-sm font-semibold text-red-600 shadow-sm hover:bg-red-700"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
